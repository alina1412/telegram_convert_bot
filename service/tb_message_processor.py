...
class TbMessageProcessor:
    ...
    async def process_text(self, message):
        ...
        await self.telebot_api.sendMessage(text=answer, chat_id=chat_id)
        ...
        with TemporaryDirectory(prefix="telebot_") as tmpdirname:
            ...
            await self.prepare_and_send_mp3(document_path, chat_id)
    ...
    async def process_file(self, message):
        ...
        with TemporaryDirectory(prefix="telebot_") as tmpdirname:
            document_path = await self.telebot_api.download_document(doc, tmpdirname)
            await self.prepare_and_send_mp3(document_path, chat_id)
    ...
    async def prepare_and_send_mp3(self, document_path, chat_id):
        ...
        with open(document_path_mp3, "rb") as mp3_file:
            ...
            await self.telebot_api.sendAudio(chat_id=chat_id, audio=tb_file)
